...
train_dataloader = dict(
    batch_size=4,
    dataset=dict(
        ann_file=f'data/MedFMC_train/{dataset}_new/{dataset}_{nshot}-shot_train_exp{exp_num}.txt',
...
val_dataloader = dict(
    batch_size=8,
    dataset=dict(
        ann_file=f'data/MedFMC_train/{dataset}_new/{dataset}_{nshot}-shot_val_exp{exp_num}.txt',
