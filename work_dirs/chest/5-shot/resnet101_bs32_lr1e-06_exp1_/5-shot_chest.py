...
resume = False
run_name = 'resnet101_bs32_lr1e-06_exp1_'
test_cfg = dict()
...
train_dataloader = dict(
    ...
    collate_fn=dict(type='default_collate'),
    dataset=dict(
        ann_file='data/MedFMC_train/chest/chest_5-shot_train_exp1.txt',
        data_prefix='data/MedFMC_train/chest/images',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
val_dataloader = dict(
    ...
    collate_fn=dict(type='default_collate'),
    dataset=dict(
        ann_file='data/MedFMC_train/chest/chest_5-shot_val_exp1.txt',
        data_prefix='data/MedFMC_train/chest/images',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(scale=448, type='Resize'),
...
work_dir = 'work_dirs/chest/5-shot/resnet101_bs32_lr1e-06_exp1_'
