...
resume = False
run_name = 'densenet121_bs1_lr1e-06_exp1_'
test_cfg = dict()
...
train_bs = 1
train_cfg = dict(by_epoch=True, max_epochs=20, val_interval=50)
...
work_dir = 'work_dirs/colon/5-shot/densenet121_bs1_lr1e-06_exp1_'
