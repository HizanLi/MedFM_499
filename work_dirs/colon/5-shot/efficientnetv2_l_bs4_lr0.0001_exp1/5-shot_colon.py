...
resume = False
run_name = 'efficientnetv2_l_bs4_lr0.0001_exp1'
test_cfg = dict()
...
train_bs = 4
train_cfg = dict(by_epoch=True, max_epochs=20, val_interval=25)
train_dataloader = dict(
    batch_size=4,
    collate_fn=dict(type='default_collate'),
    dataset=dict(
        ann_file='data/MedFMC_train/colon/colon_5-shot_train_exp1.txt',
        data_prefix='data/MedFMC_train/colon/images',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
val_dataloader = dict(
    ...
    collate_fn=dict(type='default_collate'),
    dataset=dict(
        ann_file='data/MedFMC_train/colon/colon_5-shot_val_exp1.txt',
        data_prefix='data/MedFMC_train/colon/images',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(crop_padding=0, crop_size=480, type='EfficientNetCenterCrop'),
...
work_dir = 'work_dirs/colon/5-shot/efficientnetv2_l_bs4_lr0.0001_exp1'
